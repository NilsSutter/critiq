...
class SendSlackMessageAllJob < ApplicationJob
  ...
  def perform(*args)
    ...
    message_text = "Hi! #{sender} wants a Critiq. #{others.to_words.capitalize} other people have been messaged and everyone's responses will be anonymized. #{sender} asks:\n"
